...
function generateFiles(options) {
    return (host, context) => {
        ...
        return schematics_1.mergeWith(schematics_1.apply(schematics_1.url('./files'), [
            schematics_1.template(Object.assign(Object.assign({ tmpl: '' }, options), { projectRoot: projectConfig.root, offsetFromRoot: workspace_3.offsetFromRoot(projectConfig.root) })),
