(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@angular/common/http'),require('@angular/common'),exports, require('@angular/core'), require('@angular/common'), require('@angular/common/http'), require('rxjs'), require('rxjs/operators'), require('jsrsasign')) :
    typeof define === 'function' && define.amd ? define('angular-oauth2-oidc', ['@angular/core','@angular/common/http','@angular/common','exports', '@angular/core', '@angular/common', '@angular/common/http', 'rxjs', 'rxjs/operators', 'jsrsasign'], factory) :
    (global = global || self, factory(global.ng.core,global.ng.common.http,global.ng.common,global['angular-oauth2-oidc'] = {}, global.ng.core, global.ng.common, global.ng.common.http, global.rxjs, global.rxjs.operators, global.jsrsasign));
}(this, function (ɵngcc0,ɵngcc1,ɵngcc2,exports, core, common, http, rxjs, operators, jsrsasign) { 'use strict';
